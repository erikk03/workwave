        ...
        <div className="col-span-full md:col-span-6 md:max-w-2xl xl:col-span-4 xl:max-w-5xl sm:max-w-xl mx-auto w-full">
            <div className="mt-5 mb-5 rounded-xl border-2 border-black">
                ...
                >
                    ...
                    {errors.firstName && <p className="text-red-500 ml-2">{errors.firstName}</p>}
                    ...
                    {errors.lastName && <p className="text-red-500 ml-2">{errors.lastName}</p>}
                    ...
                    {errors.phone && <p className="text-red-500 ml-2">{errors.phone}</p>}
